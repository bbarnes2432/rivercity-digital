...
export default function MockupRequestForm() {
  ...
  return <form id="wd-mockup-form" className="wd-form" onSubmit={submit} aria-busy={status === "submitting"} aria-labelledby="mockup-form-heading">
    <div id="start" className="wd-form-heading" tabIndex={-1}><span className="wd-eyebrow">Free design preview</span><h3 id="mockup-form-heading">Request a website mockup.</h3><p>We’ll follow up to discuss your business and a design preview. No obligation to build.</p></div>
