...
- Original section components and style sheets remain byte-identical in Git to 2831543. Contact/delivery routes, call-forwarding and ClickCease code remain unchanged from the working release. No JavaScript warnings/errors were captured during the final local review.
